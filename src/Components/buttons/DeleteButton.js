...
const DeleteButton = (props) => {
  ...
  return (
    <div>
      ...
      <Button variant="outlined" onClick={handleClickOpen}  style={{ height: 30,width: 150,color: "white"}}>
        Delete
      </Button>
      <Dialog
        open={open}
      ...
      >
        ...
        <Button onClick={handleDelete}   variant="outlined"  style={{borderColor:"white",marginLeft: '5px', height: 30,width: 450 }}>Delete</Button>
          <Button onClick={handleClose}  variant="outlined"  style={{borderColor:"white",marginRight:'5px', height: 30,width: 450 }}>Cancel</Button>
        </DialogActions>
      </Dialog>
    </div>
  );
